					...
					<div class="panel panel-default" style="padding: 20px;">
						<form action="" method="post" class="form-group form-container" >
							...
							<div class="form-group">
								...
								<input type="password" required name="old_password" id="password" placeholder="Current Password" class="form-control">
							</div>
							<div class="form-group">
								<label for="new_password">New Password</label>
								<input type="password" required name="new_password" id="cpassword" placeholder="New Password" class="form-control">
							</div>

							<div class="form-group">
								<label for="c_password">Confirm Password</label>
								<input type="password" required name="c_password" id="npassword" placeholder="Confirm Password" class="form-control">
	        					...
	        					// Change the type of input to password or text
    	   							function Toggle() {
        				    			...
        				    			var temp2 = document.getElementById("npassword");
					...
					<div class="panel panel-default" style="padding: 20px;">
						<form action="" method="post" class="form-group form-container" >
							...
							<div class="form-group">
								...
								<input type="password" required name="account_password" id = "opassword" placeholder="Current Password" class="form-control">
	        					...
	        					// Change the type of input to password or text
    	   							function Toggle() {
			        	    			var temp = document.getElementById("opassword");
            							if (temp.type === "password") 
			                				temp.type = "text";	
	        			    			else
    	            						temp.type = "password";    
