	...
	if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])){
		...
		if(isset($_POST['date'])){
			...
			$showForm = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>Are you sure to update your record!!<br>You won\'t be able to donate the blood for next Three months!</strong>
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<div class="test-success text-center" id="data" style="margin-top: 20px;"> <?php if (isset($showForm))
							echo $showForm;  ?><!-- Display Message here--></div>
								...
								echo '<form target="" method="post">
									...
									if($diffMonth >=3){
										...
										echo '<div class="donors_data">
											<center><span class="name">"Congratulations!! "</span><br>
											<span>You Saved a life. You will be able to donate the blood after three months. We are very thanksful to you!</span></center>
											</div>';
									}
								}
							?>
